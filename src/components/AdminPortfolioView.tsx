      ...
      <div className="bg-tertiary-900 border border-tertiary-800 rounded-2xl p-6 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button
            type="button"
            onClick={loadData}
            className="inline-flex items-center gap-2 px-4 py-2 bg-tertiary-800 hover:bg-tertiary-700 text-slate-200 text-xs font-semibold rounded-xl border border-tertiary-700 transition-colors shadow-sm self-start md:self-auto"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
          <div className="bg-tertiary-950/80 border border-tertiary-800 rounded-xl p-4">
          ...
          <div className="bg-tertiary-950/80 border border-tertiary-800 rounded-xl p-4">
            ...
            <div className="flex items-center justify-between">
              <span className="text-2xl font-black text-secondary-400">{totalPendingRtw}</span>
              <AlertTriangle className="w-5 h-5 text-secondary-400" />
            </div>
            <span className="text-[11px] text-secondary-400/80 mt-1 block">£45,000 civil liability risk</span>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full bg-tertiary-950 border border-tertiary-800 rounded-xl pl-9 pr-4 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-primary-500"
            />
          </div>
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-tertiary-800 text-slate-300">
              {filteredMetrics.map((m) => (
                <tr key={m.businessId} className="hover:bg-tertiary-800/40 transition-colors">
                  <td className="p-3.5">
                  ...
                  <td className="p-3.5">
                    {m.pendingRtwCount > 0 ? (
                      <span className="px-2 py-0.5 rounded text-[11px] font-bold bg-secondary-900/80 text-secondary-300 border border-secondary-700">
                  ...
                  <td className="p-3.5 text-right">
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-3 py-1.5 bg-primary-600 hover:bg-primary-500 text-white font-semibold rounded-lg transition-colors shadow-sm text-xs"
                    >
