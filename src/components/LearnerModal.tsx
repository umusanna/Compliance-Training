          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-white focus:border-blue-500 focus:outline-none"
              >
                <option value="manager" className="bg-slate-900">Manager / Director</option>
                <option value="supervisor" className="bg-slate-900">Supervisor / Lead</option>
                <option value="field_worker" className="bg-slate-900">Field / Frontline Staff</option>
          ...
          <div className="space-y-2 pt-2 border-t border-slate-800">
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-white focus:border-blue-500 focus:outline-none"
              >
                <option value="verified_statutory_excuse" className="bg-slate-900">
                  Verified Statutory Excuse (Checked & Defended)
                </option>
                <option value="pending_verification" className="bg-slate-900">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-8 pr-3 py-2 text-white font-mono uppercase focus:border-blue-500 focus:outline-none"
                  />
                </div>
              </div>
            )}
